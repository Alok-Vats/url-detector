...
This folder contains submission-ready support material for the project report.
...
1. Home page with URL and email forms
2. URL result page for a phishing example
3. Email result page for a legitimate example
4. Scan history page showing both URL and email records
